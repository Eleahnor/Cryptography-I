...
tuple<int, int, int> recursiveExtendedGCD(int n, int a) {
    ...
    // En lugar de usar "auto[r, x, y]", desglosamos la tupla manualmente
    tuple<int, int, int> result = recursiveExtendedGCD(a, n % a);
    int r = get<0>(result);
    int x = get<1>(result);
    int y = get<2>(result);
...
int recursiveModInverse(int n, int a) {
    tuple<int, int, int> result = recursiveExtendedGCD(n, a);
    int r = get<0>(result);
    int x = get<1>(result);
    int y = get<2>(result);
